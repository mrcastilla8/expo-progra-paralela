 ...
 *      Ejecucion comparativa con 2, 4 y 8 hilos en formato de tabla ASCII.
 *   6. Experiencia de Usuario (UI/UX):
 *      - Wizard interactivo de configuracion por consola.
 *      - Barras de progreso dinamicas (\r) no-bloqueantes.
 *      - Colores ANSI para certificaciones y metricas.
 *      - Formateo inteligente de tiempos (ms/segundos).
 *
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Modo Wizard Interactivo si no se proporcionan argumentos CLI
        if (args.length == 0) {
    ...
    // =========================================================================
    // RUTINA 3: BENCHMARK Y ESCALABILIDAD MULTIHILO (2, 4 y 8 HILOS) - TABLA ASCII
    // =========================================================================

    /**
     * Realiza mediciones de rendimiento variando la cantidad de hilos (2, 4 y 8)
     * en una tabla ASCII profesional de alta legibilidad.
     */
    ...
    // =========================================================================
    // UTILIDADES DE PRESENTACION Y UI/UX
    // =========================================================================

    /**
     * Imprime una barra de progreso dinamica en la consola mediante retorno de carro.
     */
    ...
    /**
     * Formatea milisegundos a una representacion amigable para humanos.
     */
